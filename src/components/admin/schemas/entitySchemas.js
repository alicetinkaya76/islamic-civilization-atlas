...
export const SCHEMAS = {
  ...
  rulers: {
    ...
    fields: [
      ...
      { key: 'lat',      type: 'number',    label: 'Enlem',       step: 0.01 },
      { key: 'lon',      type: 'number',    label: 'Boylam',      step: 0.01 },
      { key: 'pred',     type: 'ref',       label: 'Selef',       refCollection: 'rulers', nullable: true },
      { key: 'succ',     type: 'ref',       label: 'Halef',       refCollection: 'rulers', nullable: true },
...
export const COLLECTION_ORDER = [
  ...
  'cities', 'routes', 'rulers', 'madrasas', 'analytics',
