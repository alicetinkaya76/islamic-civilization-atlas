 ...
 *            array-coords, array-text, trilingual
 */
...
export const SCHEMAS = {
  ...
  routes: {
    ...
    fields: [
      ...
      { key: 'wp',       type: 'array-coords', label: 'Güzergah Noktaları' },
      { key: 'type',     type: 'text',      label: 'Tür',         trilingual: true },
  ...
  waqfs: {
    ...
    fields: [
      ...
      { key: 'lat',            type: 'number',    label: 'Enlem',              step: 0.01 },
      { key: 'lon',            type: 'number',    label: 'Boylam',             step: 0.01 },
      { key: 'founder_tr',     type: 'text',      label: 'Kurucu (TR)' },
      { key: 'founder_en',     type: 'text',      label: 'Founder (EN)' },
      { key: 'founder_ar',     type: 'text',      label: 'المؤسس (AR)',       rtl: true },
      { key: 'type_tr',        type: 'text',      label: 'Tür (TR)' },
      { key: 'type_en',        type: 'text',      label: 'Type (EN)' },
      { key: 'type_ar',        type: 'text',      label: 'النوع (AR)',         rtl: true },
      { key: 'beneficiary_tr', type: 'text',      label: 'Faydalananlar (TR)' },
      { key: 'beneficiary_en', type: 'text',      label: 'Beneficiaries (EN)' },
      { key: 'beneficiary_ar', type: 'text',      label: 'المستفيدون (AR)',    rtl: true },
      { key: 'dyn',            type: 'text',      label: 'Hanedan' },
      { key: 'city_tr',        type: 'text',      label: 'Şehir (TR)' },
      { key: 'city_en',        type: 'text',      label: 'City (EN)' },
      { key: 'city_ar',        type: 'text',      label: 'المدينة (AR)',       rtl: true },
      { key: 'endowment_tr',   type: 'textarea',  label: 'Vakfiye (TR)' },
      { key: 'endowment_en',   type: 'textarea',  label: 'Endowment (EN)' },
      { key: 'endowment_ar',   type: 'textarea',  label: 'الوقفية (AR)',       rtl: true },
      { key: 'status_tr',      type: 'text',      label: 'Durum (TR)' },
      { key: 'status_en',      type: 'text',      label: 'Status (EN)' },
      { key: 'status_ar',      type: 'text',      label: 'الحالة (AR)',        rtl: true },
      { key: 'narr_tr',        type: 'richtext',  label: 'Anlatı (TR)' },
      { key: 'narr_en',        type: 'richtext',  label: 'Narrative (EN)' },
      { key: 'narr_ar',        type: 'richtext',  label: 'السرد (AR)',         rtl: true },
    ]
  },
};
